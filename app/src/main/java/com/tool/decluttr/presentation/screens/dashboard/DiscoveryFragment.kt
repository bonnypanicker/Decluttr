...
class DiscoveryFragment : Fragment(R.layout.fragment_discovery) {
    ...
    private fun initViews(v: View) {
        ...
        emptyStateRoot = v.findViewById(R.id.empty_state)
        emptyStateTitle = emptyStateRoot.findViewById(R.id.empty_title)
        emptyStateSubtitle = emptyStateRoot.findViewById(R.id.empty_subtitle)
        emptyStateCta = emptyStateRoot.findViewById(R.id.empty_cta)
        emptyStateIllustration = emptyStateRoot.findViewById(R.id.empty_illustration)
            ...
            if (allApps.isNotEmpty()) {
                ...
                items.add(
                    DashboardItem.StorageMeter(
                        ...
                        usesUsageSignal = estimate.usesUsageSignal
                    )
                )
            }
    ...
    private fun estimateStorageFreed(
        ...
        estimatedBytes = estimatedBytes.coerceAtMost(capByCandidates).coerceAtLeast(0L)
